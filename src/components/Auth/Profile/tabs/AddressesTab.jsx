  ...
  return (
    <>
      <div className='grid grid-cols-2 gap-[30px]'>
        <div className='bg-primarygray w-full border p-5'>
          <div className='flex items-center justify-between'>
            <p className='title text-[22px] font-semibold'>Address #1</p>
            <button
              type='button'
              className='flex h-[34px] w-[34px] items-center justify-center rounded-full border border-gray-500'
            >
              <svg
                width='17'
                height='19'
          ...
          <div className='mt-5'>
            <table>
              <tbody>
                <tr className='mb-3 flex'>
                  <td className='text-gray-500two line-clamp-1 block w-[70px] text-base'>
                    <div>Name:</div>
                  </td>
                  <td className='text-qblack line-clamp-1 text-base font-medium'>
                    Shuvo Khan
                  </td>
                </tr>
                <tr className='mb-3 flex'>
      ...
      <div className='mt-4 h-[50px] w-[180px]'>
