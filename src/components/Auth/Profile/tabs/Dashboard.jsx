    ...
    <>
      <div className='welcome-msg w-full'>
        <div>
          ...
          <h1 className='text-qblack text-[24px] font-bold'>
            Welcome to your Profile
          </h1>
        </div>
      </div>
      <div className='quick-view-grid mt-3 flex w-full items-center justify-between'>
        <div className='qv-item bg-qblack group h-[208px] w-[252px] p-6 transition-all duration-300 ease-in-out hover:bg-accent'>
          <div className='flex h-[62px] w-[62px] items-center justify-center rounded bg-white'>
            <span>
              <svg
                width='36'
                height='37'
          ...
          <p className='mt-5 text-xl text-white group-hover:text-gray-900'>
            New Orders
          </p>
          <span className='mt-1 block text-[40px] font-bold leading-none text-white group-hover:text-gray-900'>
            656
          </span>
        </div>
        <div className='qv-item bg-qblack group h-[208px] w-[252px] p-6 transition-all duration-300 ease-in-out hover:bg-accent'>
      ...
      <div className='dashboard-info bg-primarygray mt-8 flex items-center justify-between px-7 py-7'>
        <div className=''>
          ...
          <div className='mt-5'>
            <table>
              <tbody>
                <tr className='mb-5 inline-flex'>
                  <td className='text-gray-500two block w-[100px] text-base'>
                    <div>Name:</div>
                  </td>
                  <td className='text-qblack text-base font-medium'>
                    Shuvo khan
                  </td>
                </tr>
                <tr className='mb-5 inline-flex'>
                ...
                <tr className='mb-5 inline-flex'>
                  ...
                  <td className='text-qblack text-base font-medium'>4040</td>
                </tr>
              </tbody>
            </table>
          </div>
        </div>
        <div className='h-[164px] w-[1px] bg-[#E4E4E4]'></div>
        <div className='ml-6'>
