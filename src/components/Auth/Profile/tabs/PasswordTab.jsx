  ...
  return (
    <div className='changePasswordTab w-full'>
      <div className='flex w-full flex-col-reverse space-x-5 xl:flex-row xl:items-center'>
        <div className='mb-10 w-[397px]'>
          <div className='input-field mb-6'>
            <label
              className='input-label mb-2.5 block text-sm text-gray-500'
              htmlFor='old_password'
            >
              Old Password*
            </label>
            <div className='input-wrapper relative h-[58px] w-full overflow-hidden border border-[#E8E8E8]'>
              <input
                placeholder='● ● ● ● ● ●'
                className='input-field text-bese text-dark-gray h-full w-full bg-[#FAFAFA] px-4 placeholder:text-base focus:outline-none focus:ring-0'
                type='password'
                id='old_password'
              />
              <div
                className='absolute bottom-[17px] right-6 z-10 cursor-pointer'
          ...
          <div className='mt-[30px] flex w-full justify-start'>
            <div className='items-center sm:flex sm:space-x-[30px]'>
              ...
              <button type='button'>
                <div className='text-qblack mb-5 w-full text-sm font-semibold sm:mb-0'>
                  Cancel
                </div>
              </button>
            </div>
