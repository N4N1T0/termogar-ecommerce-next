    ...
    <>
      <div className='flex space-x-8'>
        <div className='w-[570px]'>
          <div className='input-item mb-8 flex space-x-2.5'>
        ...
        <div className='flex-1'>
          <div className='update-logo mb-9 w-full'>
            ...
            <p className='text-gray-500two mb-5 text-sm'>
              ...
              <span className='text-qblack ml-1'>300x300</span>. Gifs work too.
            ...
            <div className='flex justify-start xl:justify-center'>
              <div className='relative'>
                ...
                <div
                  ...
                  className='bg-qblack absolute bottom-7 right-[105px] h-[32px] w-[32px] cursor-pointer rounded-full sm:right-0'
                >
                  <svg
                    width='32'
                    height='32'
      ...
      <div className='action-area flex items-center space-x-4'>
        <button type='button' className='text-sm font-semibold text-red-500'>
          Cancel
        </button>
        <button
          type='button'
          className='bg-qblack h-[50px] w-[164px] text-sm text-white'
        >
          Update Profile
        </button>
      </div>
