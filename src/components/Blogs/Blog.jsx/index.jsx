      ...
      <div className='blog-page-wrapper w-full'>
        ...
        <div className='content-area w-full'>
          <div className='container-x mx-auto'>
            <div className='blog-article mb-7 lg:flex lg:space-x-[30px]'>
              <div className='flex-1'>
                <div className='img h-[457px] w-full'>
                  <img
                    src={`${
                ...
                <div className='blog pl-[24px] pt-[24px]'>
                  ...
                  <div className='details'>
                    <h1 className='text-qblack mb-1 line-clamp-2 text-[22px] font-semibold capitalize'>
                      Business-to-consumer that involves selling fight into the
                      find to a products and services
                    </h1>
                    <p className='text-gray-500two mb-10 text-[15px] leading-[30px]'>
                ...
                <div className='extra-content w-full'>
                  <div className='mb-3 w-full sm:flex sm:space-x-[30px]'>
                    <div className='h-[235px] sm:w-[370px]'>
                      <img
                        src={`${
                          process.env.NEXT_PUBLIC_URL
                  ...
                  <div className='mb-10 pl-[24px]'>
                    <h1 className='text-qblack mb-2 text-[22px] font-semibold'>
                      Selling fight into the find to a products and services?
                    </h1>
                    <p className='text-gray-500two mb-7 text-[15px]'>
                      ten occasional saw everything but conviction. Daughter
                      returned quitting few are day advanced branched. Do
                      enjoyment defective objection or we if favourite. At
                      wonder afford so danger cannot former seeing. Power visit
                  ...
                  <div className='comment-area mt-4 w-full'>
                    <div className='mb-[30px] w-full items-center justify-between sm:flex'>
                      <div className='tags mb-5 flex items-center space-x-5 sm:mb-0'>
                        <span className='text-qblack text-2xl'>Tags:</span>
                        <span className='text-gray-500two text-base hover:text-accent'>
                          #Technology
                        </span>
                        <span className='text-gray-500two text-base hover:text-accent'>
                          #Agency
                      ...
                      <div className='tags flex items-center space-x-5'>
                        <span className='text-qblack text-2xl'>Share:</span>
              ...
              <div className='w-full lg:w-[370px]'>
                <div
                  data-aos='fade-up'
                  className='search-widget mb-[30px] w-full bg-white p-[30px]'
                >
                  <h1 className='text-qblack mb-5 text-[22px] font-bold'>
                    Search
                  </h1>
                  <div className='mb-5 h-[1px] w-full bg-[#DCDCDC]'></div>
                  <div className='relative h-[60px] w-full'>
                    <input
                      type='text'
                      placeholder='Search'
                      className='placeholder:text-gray-500two h-full w-full bg-[#F9F3E9] pl-5 pr-16 focus:outline-none focus:ring-0'
                    />
                ...
                <div
                  data-aos='fade-up'
                  className='latest-post-widget mb-[30px] w-full bg-white p-[30px]'
                >
                  <h1 className='text-qblack mb-5 text-[22px] font-bold'>
                    Latest Post
                  </h1>
                  ...
                  <ul className='flex flex-col space-y-5'>
                    <li className='flex h-[95px] items-center space-x-5'>
                      <div className='h-full w-[85px] overflow-hidden rounded'>
                        <img
                          src={`${
                            process.env.NEXT_PUBLIC_URL
                      ...
                      <div className='flex h-full flex-1 flex-col justify-between'>
                        <p className='text-qblack line-clamp-2 text-[18px] leading-7'>
                        ...
                        <div className='flex items-center space-x-3'>
                          ...
                          <span className='text-gray-500two text-sm'>
                            31 May 2022
                          </span>
                        </div>
                      </div>
                ...
                <div
                  data-aos='fade-up'
                  className='categories-widget mb-[30px] w-full bg-white p-[30px]'
                >
                  <h1 className='text-qblack mb-5 text-[22px] font-bold'>
                    Categories
                  </h1>
                  ...
                  <ul className='flex flex-col space-y-5'>
                    <li className='group flex items-center justify-between'>
                      <span className='text-gray-500two text-base group-hover:text-accent'>
                        Development
                      </span>
                      <span className='text-gray-500two text-base group-hover:text-accent'>
                        (6)
                ...
                <div
                  data-aos='fade-up'
                  className='popular-tag-widget mb-[30px] w-full bg-white p-[30px]'
                >
                  <h1 className='text-qblack mb-5 text-[22px] font-bold'>
                    Popular Tags
                  </h1>
                  ...
                  <div className='filter-items'>
                    <div className='flex flex-wrap gap-[10px]'>
                      <span className='hover:text-qblack mb-[5px] cursor-pointer bg-[#F9F3E9] px-[14px] py-[6px] text-base text-[#9A9A9A] hover:bg-accent'>
                        Agency
                      </span>
                      <span className='hover:text-qblack mb-[5px] cursor-pointer bg-[#F9F3E9] px-[14px] py-[6px] text-base text-[#9A9A9A] hover:bg-accent'>
                        Creative
                ...
                >
                  <div className='flex h-full w-full flex-col justify-between bg-black bg-opacity-75 p-[30px]'>
                    <div>
                      <h1 className='mb-5 text-[22px] font-bold text-white'>
                        Our Newsletter
                      </h1>
                    ...
                    <div>
                      <div className='mb-3.5 w-full'>
                        <input
                          type='text'
                          className='h-[60px] w-full bg-[#ECEAEC] pl-5 placeholder:text-[#9A9A9A] focus:outline-none focus:ring-0'
                          placeholder='Enter Your Email Address'
                        />
                      </div>
                      <button type='button' className='h-[60px] w-full'>
                        <span
                          className='yellow-btn h-full w-full'
                          style={{ fontSize: '18px' }}
                        >
                          Subscribe
                        </span>
