        ...
        <div className='container-x mx-auto'>
          <div className='main-wrapper w-full lg:flex lg:space-x-[30px]'>
            <div className='w-full lg:w-1/2'>
              <h1 className='text-qblack mb-1 text-[22px] font-semibold leading-[30px]'>
                Contact Information
              </h1>
              <p className='text-gray-500two mb-5 text-[15px] leading-[30px]'>
                Fill the form below or write us .We will help you as soon as
                possible.
              </p>

              <div className='mb-[30px] xl:flex xl:space-x-[30px]'>
                <div className='item flex h-[196px] w-full flex-col justify-center bg-[#FFEAE5] p-5 xl:w-1/2'>
                  ...
                  <p className='text-center text-[22px] font-semibold leading-[30px] text-black'>
                    Phone
                  </p>
              ...
              <div className='flex w-full flex-col justify-between bg-[#E7F2EC] p-5'>
                <div className='flex space-x-5'>
                  ...
                  <div>
                    <h1 className='text-qblack mb-2 text-[22px] font-semibold leading-[30px]'>
                      Address
                    </h1>
                    <p className='text-qblack text-[15px] leading-[30px]'>
            ...
            <div className='flex-1 bg-white p-3 sm:p-10'>
              <div className='title flex flex-col items-center'>
                <h1 className='text-qblack text-[34px] font-bold'>
                  Get In Touch
                </h1>
