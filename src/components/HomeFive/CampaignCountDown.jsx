      ...
      <div className={`w-full lg:h-[460px] ${className || ''}`}>
        <div className='container-x mx-auto h-full'>
          <div className='h-full items-center'>
            <div
              data-aos='fade-right'
              className='campaign-countdown mb-5 h-full w-full lg:mb-0'
              style={{
                background: `url(${
            ...
            >
              <Link to='/flash-sale'>
                <div className='w-full p-5 xl:p-12'>
                  <div className='countdown-wrapper mb-10 flex w-full space-x-[23px]'>
                  ...
                  <div className='countdown-title mb-4'>
                    <h1 className='text-qblack text-[44px] font-medium'>
                      WOO! Flash Sale
                    </h1>
                    <p className='text-qblack text-[18px] leading-7'>
                      You get into the 2k+ best Products in Flash offer with
                      <br /> a special-shaped sofa for sale.
                    </p>
                  </div>
                  <div className='border-qblack h-8 w-[100px] border-b'>
