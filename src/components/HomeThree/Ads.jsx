  ...
  return (
    <>
      <div className='fixed left-0 top-0 z-40 flex h-full w-full items-center justify-center'>
        ...
        ></div>
        <div
          className='relative z-50 flex w-[310px] flex-col justify-between bg-slate-700 py-[108px] pl-3 md:h-[509px] md:w-[812px] md:pl-10'
          style={{
            background: `url(${
        ...
        >
            ...
            <div className='logo mb-[20px]'>
              <Link to='/'>
                <img
                  width='152'
                  height='36'
                  src={`${process.env.NEXT_PUBLIC_URL}/assets/images/logo.svg`}
                  alt='logo'
                />
              </Link>
            </div>
            <p className='text-qblack mb-2 text-sm md:text-[22px]'>
              by Subscribe our Newsletter
            </p>
            <h1 className='text-qblack mb-1 text-xl font-bold md:text-[30px]'>
          ...
          <div className='mt-8 h-[54px] w-full sm:flex md:w-[415px]'>
            ...
            <button
              type='button'
              className='font-600 h-full w-[120px] bg-accent text-sm'
            >
              Subscribe
            </button>
          </div>
