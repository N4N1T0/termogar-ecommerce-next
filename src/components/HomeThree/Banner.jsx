...
export default function Banner({ className }) {
  ...
  return (
    <>
      <div className={`h-[500px] w-full xl:h-[733px] ${className || ''}`}>
        <div className='main-wrapper h-full w-full'>
          <div className='hero-slider-wrapper relative mb-20 w-full xl:mb-0 xl:h-full'>
            <div className='absolute left-0 top-0 hidden h-full w-full items-center justify-between xl:flex'>
              <button
                type='button'
                onClick={() => sliderRef.current.slickPrev()}
                className='relative left-5 z-10 cursor-pointer text-[#8cb1f6] hover:text-blue-500 2xl:left-32'
              >
                <svg
              ...
              <button
                ...
                className='relative right-5 z-10 cursor-pointer text-[#8cb1f6] hover:text-blue-500 2xl:right-32'
              >
                <svg
                  width='84'
                  height='68'
                ...
                >
                  <div className='container-x mx-auto flex h-full items-center'>
                    <div className='h-full w-full items-center pt-20 xl:flex xl:pt-0'>
                      <div className='w-full xl:w-[626px]'>
                        <p className='mb-[7px] text-[20px] font-medium text-white md:text-[34px]'>
                          VR BOX 3D Glass
                        </p>
                        <h1 className='mb-[44px] text-[40px] font-bold leading-[40px] text-white md:text-[66px] md:leading-[80px]'>
                        ...
                        <Link to='#' passhref='true'>
                          <div rel='noopener noreferrer'>
                            <div
                              className={`group relative flex h-[52px] w-[160px] cursor-pointer items-center justify-center overflow-hidden rounded bg-blue-500 text-white transition-all duration-300 ease-in-out ${
                                className || ''
                              }`}
                            >
              ...
              <div className='item h-[500px] w-full xl:h-[733px]'>
                ...
                >
                  <div className='container-x mx-auto flex h-full items-center'>
                    <div className='h-full w-full items-center pt-20 xl:flex xl:pt-0'>
                      <div className='w-full xl:w-[626px]'>
                        <p className='mb-[7px] text-[20px] font-medium text-blue-500 md:text-[34px]'>
                          VR BOX 3D Glass
                        </p>
                        <h1 className='text-qblack mb-[44px] text-[40px] font-bold leading-[40px] md:text-[66px] md:leading-[80px]'>
                          Explore Our Tech Collection Perfect Gadget
                        </h1>
