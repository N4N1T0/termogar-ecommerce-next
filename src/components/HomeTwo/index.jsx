...
export default function HomeTwo() {
  ...
  return (
    <LayoutHomeTwo>
      ...
      <ProductsAds
        ads={[
          `${process.env.NEXT_PUBLIC_URL}/assets/images/bannera-2.2.png`,
          `${process.env.NEXT_PUBLIC_URL}/assets/images/bannera-2.1.png`
        ]}
      ...
      <ProductsAds
        ads={[`${process.env.NEXT_PUBLIC_URL}/assets/images/bannera-2.3.png`]}
        className='products-ads-section mb-[60px]'
      />
      <SectionStyleThreeHomeTwo
      ...
      <ProductsAds
        sectionHeight='164'
        ads={[`${process.env.NEXT_PUBLIC_URL}/assets/images/bannera-2.4.png`]}
        className='products-ads-section mb-[60px]'
      />
      <SectionStyleFour
        products={products}
