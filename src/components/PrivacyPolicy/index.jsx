      ...
      <div className='terms-condition-page w-full bg-white pb-[30px]'>
        ...
        <div className='w-full'>
          <div className='container-x mx-auto'>
            <div className='content-item mb-10 w-full'>
              <h2 className='text-qblack mb-5 text-[18px] font-medium'>
                1. What Are Terms and Conditions?
              </h2>
              <p className='text-gray-500two text-[15px] leading-7'>
            ...
            <div className='content-item mb-10 w-full'>
              ...
              <p className='text-gray-500two mb-10 text-[15px] leading-7'>
              ...
              <div>
                ...
                <ul className='ml-5 list-disc'>
                  <li className='text-gray-500two text-[15px] leading-7'>
