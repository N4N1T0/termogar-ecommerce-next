      ...
      <Layout>
        <div className='products-page-wrapper w-full'>
          <div className='container-x mx-auto'>
            <div
              data-aos='fade-right'
              className='saller-info relative mb-[40px] w-full items-center justify-between overflow-hidden px-11 py-10 sm:flex sm:h-[328px] sm:py-0'
              style={{
                background: `url(${
            ...
            >
              <div className='store-status absolute -left-[30px] top-[30px] flex h-[60px] w-[230px] items-center justify-end rounded-full bg-accent'>
                <span className='font-600 mr-[30px] text-[26px]'>
                  Store Open
                </span>
              </div>

              <div className='saller-text-details mt-[100px] sm:mt-[55px]'>
                <ul>
              ...
              <div className='saller-name hidden lg:block'>
              ...
              <div className='saller-logo mt-5 sm:mt-5'>
                <div className='flex justify-start sm:justify-center'>
                  <div className='mb-1 flex h-[170px] w-[170px] items-center justify-center rounded-full bg-white'>
                    <img
                      src={`${
                        process.env.NEXT_PUBLIC_URL
                ...
                <div className='flex justify-start sm:justify-center'>
                  <span className='text-center text-[30px] font-medium'>
                    Quomodosoft
                  </span>
                </div>
              </div>
