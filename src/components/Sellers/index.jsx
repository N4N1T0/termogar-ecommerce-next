...
export default function Sallers() {
  return (
    <Layout childrenClasses='pt-0 pb-0'>
      <div className='sallers-page-wrapper mb-[60px] w-full'>
        <PageTitle
          title='All Seller '
          breadcrumb={[
            { name: 'home', path: '/' },
      ...
      <div className='content-wrapper mb-[60px] w-full'>
        <div className='container-x mx-auto w-full'>
          <div className='grid grid-cols-1 gap-5 lg:grid-cols-2 lg:gap-[30px]'>
            <div data-aos='fade-up' className='item w-full'>
              <div
                className='w-full p-5 sm:h-[328px] sm:p-[30px]'
                style={{
                  background: `url(${
              ...
              >
                <div className='flex h-full w-full flex-col-reverse justify-between sm:flex-row sm:items-center'>
                  <div className='flex h-full flex-col justify-between'>
                    <div className=''>
                      <h1 className='text-qblack text-[30px] font-semibold'>
                        Fusion x
                      </h1>
                      <div className='mb-[30px] flex items-center space-x-2'>
                        ...
                        <span className='text-qblack text-[15px] font-bold'>
                          (4.7)
                        </span>
                      </div>
                  ...
                  <div>
                    <div className='flex justify-start sm:justify-center'>
                      <div className='mb-[20px] flex h-[170px] w-[170px] items-center justify-center rounded-full bg-white'>
                        <img
                          src={`${
                            process.env.NEXT_PUBLIC_URL
                    ...
                    <h1 className='text-qblack hidden text-center text-[30px] font-semibold leading-none sm:block'>
                      Fusion x
                    </h1>
                  </div>
                </div>
