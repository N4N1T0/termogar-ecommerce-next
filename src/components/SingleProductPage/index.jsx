      ...
      <Layout childrenClasses='pt-0 pb-0'>
        <div className='single-product-wrapper w-full'>
          ...
          >
            ...
            <div className='tab-contents min-h-[400px] w-full'>
              <div className='container-x mx-auto'>
                {tab === 'des' && (
                  <div data-aos='fade-up' className='tab-content-item w-full'>
                    <h6 className='text-qblack mb-2 text-[18px] font-medium'>
                      Introduction
                    </h6>
                    <p className='text-normal mb-10 text-[15px] text-gray-500'>
                    ...
                    <div>
                      <h6 className='text-medium mb-4 text-[18px]'>
                        Features :
                      </h6>
                      <ul className='ml-[15px] list-disc'>
                        <li className='font-normal leading-9 text-gray-500'>
          ...
          <div className='related-product w-full bg-white'>
            <div className='container-x mx-auto'>
              <div className='w-full py-[60px]'>
                <h1 className='font-600 mb-[30px] text-xl leading-none text-gray-900 sm:text-3xl'>
                  Related Product
                </h1>
                <div
                  data-aos='fade-up'
        ...
        {report && (
          <div className='fixed left-0 top-0 z-50 flex h-full w-full items-center justify-center'>
            <div
              ...
              className='fixed left-0 right-0 h-full w-full bg-black bg-opacity-25'
            ></div>
            <div
              data-aos='fade-up'
              className='relative h-full w-full bg-white px-[38px] py-[40px] sm:h-[509px] sm:w-[548px]'
              style={{ zIndex: '999' }}
            >
              <div className='title-bar mb-3 flex items-center justify-between'>
              ...
              <div className='inputs w-full'>
                ...
                <div className='mb-[40px] w-full'>
                  <h6 className='input-label font-600 text-qblack mb-2 block text-[13px] capitalize leading-[24px]'>
                    Enter Report Note*
                  </h6>
                  <textarea
                    name=''
                    ...
                    cols='30'
                    rows='6'
                    className='border-gray-500-border w-full border px-4 py-3 text-sm placeholder:text-sm focus:outline-none focus:ring-0'
                    placeholder='Type Here'
                  ></textarea>
                </div>

                <button type='button' className='black-btn h-[50px] w-full'>
                  Submit Report
                </button>
              </div>
            </div>
