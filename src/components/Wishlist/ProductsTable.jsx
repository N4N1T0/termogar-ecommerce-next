        ...
        <table className='w-full text-left text-sm text-gray-500 dark:text-gray-400'>
          <tbody>
            ...
            <tr className='default-border-bottom whitespace-nowrap border-b bg-[#F6F6F6] px-2 text-[13px] font-medium uppercase text-black'>
              ...
              <td className='whitespace-nowrap py-4 text-center'>color</td>
              <td className='whitespace-nowrap py-4 text-center'>size</td>
            ...
            <tr className='border-b bg-white hover:bg-gray-50'>
              ...
              <td className='px-2 py-4 text-center'>
                <div className='flex items-center justify-center'>
                  <span className='block h-[20px] w-[20px] rounded-full bg-[#E4BC87]'></span>
                </div>
              </td>
              <td className='px-2 py-4 text-center'>
