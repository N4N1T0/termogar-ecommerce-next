...
export type GET_CARD_STYLE_ONE_PRODUCTS_FOR_MERCHANT_CENTERResult = Array<{
  id: string
  featuredMedia: {
    url: string | null
    blur: string | null
...
export type GET_FEATURE_BY_KEYResult = {
  state: boolean | null
}
