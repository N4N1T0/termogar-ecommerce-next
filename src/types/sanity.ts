...
// Query: *[_type=='productCategory' && slug.current == $slug][0] {  "children": *[_type=='productCategory' && references(^._id)]   {      "id": _id,    name,     "slug": slug.current,    },  "products": *[_type=='product' && status=='publish' && defined(price) && references(^._id)]{     "categories": productCategories[]->{    "id": _id,    name,    "slug": slug.current,  },    price,    "brand": *[_type == 'brand' && ^.title match title][0] {      "id": _id,      title,      "link": link.current    },  }  }
