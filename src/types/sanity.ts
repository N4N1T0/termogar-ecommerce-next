...
// Query: *[_type=='product' && status=='publish' && defined(price) && slug.current == $slug][0]{  "id": _id,  sku,  ean,  referenceCode,  "featuredMedia": {    "url": featuredMedia.asset->url,      "blur": featuredMedia.asset->metadata.lqip  },  title,  "slug": slug.current, "brand": *[_type == 'brand' && ^.title match title][0] {      title,      "link": link.current,      "featuredMedia": image.asset->url,    },    youtube,  excerpt,  "categories": productCategories[]->{    "id": _id,    name,    "slug": slug.current,    main  },  content,  price,  sale,  createdAt,  dimensions,  "stockQuantity": stockQuantity,  "options": options{  name,  "values": values[]{    value,    "slug": reference->slug.current  }},  date,  "tags": productTag[]->{    "id": _id,    name,    "slug": slug.current  }, "otherImages": relatedImages[].asset->{  "url": url,  "blur": metadata.lqip},"downloads": downloads[]{    "title": asset->title,    "url": asset->url  },variations,"relatedProducts": relatedProducts[]->{  "id": _id,},"hasLastMinute": defined(lastMinute)}
